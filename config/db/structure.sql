...
--
-- Name: screen_template_model_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX screen_template_model_id_index ON public.screen_template USING btree (model_id);
...
--
-- Name: screen_template screen_template_model_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screen_template
    ADD CONSTRAINT screen_template_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.model(id) ON UPDATE CASCADE ON DELETE CASCADE;
